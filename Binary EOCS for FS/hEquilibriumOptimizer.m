...
function EO = hEquilibriumOptimizer(feat,label,opts)
% Parameters
lb    = 0;
ub    = 1; 
thres = 0.5; 
...
while t <= max_Iter
  ...
  for d = 1:dim
    ...
    best=X(index,:);
%     for i = 1:N
%         X(i,:) = get_cuckoos_2(X(i,:),best,lb,ub);
%     end


%   Xeq1 = get_cuckoos_2(Xeq1,)
Xeq1 = get_cuckoos_2(Xeq1,best,lb,ub);
Xeq2 = get_cuckoos_2(Xeq2,best,lb,ub);
Xeq3 = get_cuckoos_2(Xeq3,best,lb,ub);
Xeq4 = get_cuckoos_2(Xeq4,best,lb,ub);
Xave = get_cuckoos_2(Xave,best,lb,ub);
